...
it('includes default options', () => {
    ...
    render(<QuestionDisplay 
        ...
        expect(screen.getByRole('button', { name: /A website not listed/i })).toBeInTheDocument()
        expect(screen.getByRole('button', { name: /Redirects to another website/i })).toBeInTheDocument()
});
